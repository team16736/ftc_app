...
/**
 * Purpose: Go to the LEFT side
 *
 * Strafes to the RIGHT and goes forward (which is the LEFT side of the bridge)
 */
@Autonomous(name = "Auto Left Foundation", group = "GoBilda")
public class GoLeftAndPullFoundation extends LinearOpMode {
